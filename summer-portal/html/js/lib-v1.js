...
var category = {OBJ: $("#_JD_ALLSORT"),
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	//直接使用ajax请求json数据
//    	$.getJSON(this.URL_Serv_Serv, function(json){
