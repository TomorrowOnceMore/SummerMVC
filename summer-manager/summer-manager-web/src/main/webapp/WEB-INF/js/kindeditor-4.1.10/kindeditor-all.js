...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&com.summer.order=' + order + '&dir=' + dirName;
 ...
 *   since many of the settings need to be passed to Flash in com.summer.order to take
 *   effect.
 * *********************** */
...
/* *******************************
	...
	This ensures that events are executed in a determinate com.summer.order and that
...
// we must queue them in com.summer.order to garentee that they are executed in com.summer.order.
